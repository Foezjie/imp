...
from Imp.ast.variables import Variable, ResultVariable, Reference
...
class Statement(object):
    """ 
        An abstract baseclass representing a statement in the configuration 
        policy.
    """
    def __init__(self):
        self.filename = "<>"
    ...
    def can_evaluate(self, state):
        """ 
            Can this statement be evaluated given 'state'. This method may not 
