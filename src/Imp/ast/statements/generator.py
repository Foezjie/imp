...
from Imp.ast.entity import Default
from Imp.ast.statements.assign import SetAttribute
from Imp.ast.variables import AttributeVariable, Reference, Variable
...
#        # check expr implementations
#        if len(select_list) > 1:
#            raise Exception(
#                "More than one non-default implementation for %s available" %
...
#        if len(defaults) > 1:
#            raise Exception(
#                "More than one default implementation for %s available" %
#                self.instance_type.name)
#        
#        if len(defaults) == 1:
#            return defaults[0]
