...
from Imp.ast.constraint.expression import create_function
...
class Bool(Type):
    ...
    def cast(cls, value):
        ...
        """
        if (value == "true" or value == "True" or value == 1 or value == "1" or
                value == True):
            return True
...
class ConstraintType(Type):
    """ 
        A type that is based on Number or String but defines additional 
        constraint on this type. These constraints only apply on the value
        of the type.
