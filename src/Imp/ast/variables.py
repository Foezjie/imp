...
from Imp.execute.util import Unset, EntityType, Optional
...
class Variable(object):
    ...
    def get_version(self):
        """
            Get the version of the variable. Always returns a value > 0 if 
    ...
    def cast(self, function):
        """
            Cast the value in this variable with the given function. Casting
            is performed by the variable to support validation in lazy 
            variables.
        """
        if function is not None:
...
class AttributeVariable(Variable):
    ...
    def can_compare(self):
        """
            An attribute variable can be compared when the instance is
            available. 
        """
