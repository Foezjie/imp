...
from Imp.ast.variables import ResultVariable, Reference, Variable,\
    AttributeVariable
from Imp.ast.statements.call import Expression
...
class State(object):
    ...
    def resolved(self):
        ...
        for name, type_ref in self._required_types.items():
            ...
            if result:
                self._resolved_types[name] = \
                    local_scope.resolve_reference(type_ref).value
