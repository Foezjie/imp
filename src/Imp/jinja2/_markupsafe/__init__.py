...
class Markup(str):
    ...
    def unescape(self):
        ...
        """
        from Imp.jinja2._markupsafe._constants import HTML_ENTITIES
        def handle_match(m):
            name = m.group(1)
...
try:
    from Imp.jinja2._markupsafe._speedups import escape, escape_silent, soft_unicode
except ImportError:
    from Imp.jinja2._markupsafe._native import escape, escape_silent, soft_unicode
