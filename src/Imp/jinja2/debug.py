...
import sys
import traceback
from Imp.jinja2.utils import CodeType, missing, internal_code
...
class ProcessedTraceback(object):
    ...
    def render_as_html(self, full=False):
        ...
        from Imp.jinja2.debugrenderer import render_traceback
        return '%s\n\n<!--\n%s\n-->' % (
...
try:
    from Imp.jinja2._debugsupport import tb_set_next
except ImportError:
    try:
