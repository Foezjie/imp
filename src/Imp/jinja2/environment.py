...
import os
import sys
from Imp.jinja2 import nodes
from Imp.jinja2.defaults import *
from Imp.jinja2.lexer import get_lexer, TokenStream
from Imp.jinja2.parser import Parser
from Imp.jinja2.optimizer import optimize
from Imp.jinja2.compiler import generate
from Imp.jinja2.runtime import Undefined, new_context
from Imp.jinja2.exceptions import TemplateSyntaxError, TemplateNotFound, \
     TemplatesNotFound
from Imp.jinja2.utils import import_string, LRUCache, Markup, missing, \
...
class Environment(object):
    ...
    def overlay(self, block_start_string=missing, block_end_string=missing,
        ...
        rv.extensions = {}
        for key, value in list(self.extensions.items()):
    ...
    def iter_extensions(self):
        ...
        return iter(sorted(list(list(self.extensions.values())),
    ...
    def compile_templates(self, target, extensions=None, filter_func=None,
        ...
        .. versionadded:: 2.4
        """
        from Imp.jinja2.loaders import ModuleLoader
    ...
    def list_templates(self, extensions=None, filter_func=None):
        ...
        if filter_func is not None:
            x = list(list(filter(filter_func, x)))
        return x
    ...
    def handle_exception(self, exc_info=None, rendered=False, source_hint=None):
        ...
        if _make_traceback is None:
            from Imp.jinja2.debug import make_traceback as _make_traceback
