...
from Imp.jinja2.exceptions import TemplateSyntaxError
from Imp.jinja2.utils import LRUCache, next
import sys
...
try:
    ...
    name_re = re.compile(r'\b([a-z]+::)?[a-zA-Z_][a-zA-Z0-9_]*\b')
else:
    from Imp.jinja2 import _stringdefs
    name_re = re.compile(r'([%s]+::)?[%s][%s]*' % (_stringdefs.xid_start, _stringdefs.xid_start,
