...
def clear_caches():
    ...
    """
    from Imp.jinja2.environment import _spontaneous_environments
    from Imp.jinja2.lexer import _lexer_cache
...
def generate_lorem_ipsum(n=5, html=True, min=20, max=100):
    ...
    from Imp.jinja2.constants import LOREM_IPSUM_WORDS
...
try:
    ...
    from Imp.jinja2._markupsafe import Markup, escape, soft_unicode
